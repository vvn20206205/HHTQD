CREATE TABLE IF NOT EXISTS `classicmodels_orders` (
    `orderNumber` INT,
    `orderDate` DATETIME,
    `requiredDate` DATETIME,
    `shippedDate` DATETIME,
    `status` VARCHAR(10) CHARACTER SET utf8,
    `comments` VARCHAR(189) CHARACTER SET utf8,
    `customerNumber` INT
);
INSERT INTO `classicmodels_orders` VALUES (10100,'2003-01-06 00:00:00','2003-01-13 00:00:00','2003-01-10 00:00:00','Shipped',NULL,363),
...
INSERT INTO `classicmodels_orders` VALUES (10118,'2003-04-21 00:00:00','2003-04-29 00:00:00','2003-04-26 00:00:00','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP',216),
