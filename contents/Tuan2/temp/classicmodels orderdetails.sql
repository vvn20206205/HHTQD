CREATE TABLE IF NOT EXISTS `classicmodels_orderdetails` (
    `officeCode` INT,
...
INSERT INTO `classicmodels_orderdetails` VALUES (1,'San Francisco','+1 650 219 4782','100 Market Street','Suite 300','CA','USA','94080',NULL),
